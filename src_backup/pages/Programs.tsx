...
import { FiBook, FiDroplet, FiCode, FiUsers, FiSun, FiMail, FiInfo, FiLayers } from 'react-icons/fi';
...
const Programs: React.FC = () => {
  // Program data with proper typing
  ...
  // Success stories data with proper typing
  const successStories: SuccessStory[] = [
    {
      title: "Education Program Impact",
      description: "Our education program has helped over 100 children improve their literacy and numeracy skills, with many now performing above grade level.",
      impact: "100+ children improved academic performance"
    },
    {
      title: "Menstrual Health Initiative",
      description: "Through our MHM program, we've distributed over 500 dignity kits and educated hundreds of girls on menstrual health and hygiene.",
      impact: "500+ dignity kits distributed"
    },
    {
      ...
      >
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Discover our initiatives designed to empower and transform lives in our community.
            </motion.p>
            <motion.div 
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-900/50 to-purple-900/20 p-5 rounded-xl border border-purple-900/30 hover:border-purple-500/50 transition-colors">
                    <div className="text-purple-300 text-3xl font-bold mb-2">We are open everyday of the week</div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center" data-aos="fade-up">
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-6 text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="200">
              ...
              <Link to="/about" className="flex items-center hover:text-cyan-400 transition-colors">
                <FiInfo className="w-4 h-4 mr-2" />
                Learn More About Us
              </Link>
              <Link to="/programs" className="flex items-center hover:text-cyan-400 transition-colors">
