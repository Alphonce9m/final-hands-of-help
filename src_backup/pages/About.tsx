...
const About: React.FC = () => {
  const impactStats = [
    ...
    { icon: <FaHandsHelping className="w-8 h-8 text-blue-600" />, number: "10+", label: "Community Projects" },
    { icon: <FaUsers className="w-8 h-8 text-blue-600" />, number: "1,000+", label: "Lives Impacted" }
  ];
