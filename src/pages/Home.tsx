  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <motion.section 
        ...
        className="relative py-32 overflow-hidden bg-gradient-to-br from-blue-900 via-black to-purple-900"
      >
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white to-purple-300">
              Hands of Help
            </h1>
